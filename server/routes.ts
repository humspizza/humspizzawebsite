...
Allow: /accessibility`;
  ...
  // Crawler meta tags injection middleware (must be added BEFORE vite/static middleware in index.ts)
  // This middleware is exported and should be used before setupVite() or serveStatic()
