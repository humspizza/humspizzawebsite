          ...
          <div className="bg-zinc-900 rounded-2xl p-8 shadow-2xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Button
                ...
                className="w-full bg-yellow-400 hover:bg-yellow-500 text-[#18181b] font-bold py-4 text-lg disabled:opacity-50 disabled:cursor-not-allowed disabled:bg-zinc-700 disabled:text-zinc-400"
              >
