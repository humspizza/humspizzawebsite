          ...
          <div className="bg-zinc-900 rounded-2xl p-8 shadow-2xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  {availableTimeSlots.length === 0 ? (
                    <div className="flex items-center h-10 w-full rounded-md border border-zinc-700 bg-zinc-800 px-3 py-2 text-sm text-zinc-400 cursor-default">
                      {language === 'vi' 
              ...
              <Button
                ...
                className="w-full bg-yellow-400 hover:bg-yellow-500 text-[#ffffff] font-bold py-4 text-lg disabled:opacity-50 disabled:cursor-not-allowed disabled:bg-zinc-700 disabled:text-zinc-400"
              >
